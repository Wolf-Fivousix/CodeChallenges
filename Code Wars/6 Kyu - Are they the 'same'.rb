...
def comp(array1, array2)
  return false if (!array1 || !array2 || array2.length < array1.length)
  power = array1.map{ |value| value * value }.sort
  power2 = array2.sort
  
  power.each.with_index do |value, index|
    return false if value != power2[index]
  end
